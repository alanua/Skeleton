...
GRAPHIFY_OWNED_VERSION_MARKER_RELATIVE_PATHS = (
    Path(".codex") / "skills" / "graphify" / ".graphify-version",
    Path(".codex") / "skills" / "graphify" / "VERSION",
    Path(".codex") / "skills" / "graphify" / "graphify.version",
    Path(".codex") / "skills" / "graphify" / "metadata.json",
    Path(".hermes") / "skills" / "graphify" / ".graphify-version",
    Path(".hermes") / "skills" / "graphify" / "VERSION",
    Path(".hermes") / "skills" / "graphify" / "graphify.version",
    Path(".hermes") / "skills" / "graphify" / "metadata.json",
)
GRAPHIFY_PROFILE_RELATIVE_PATHS = (
    *GRAPHIFY_PROFILE_ROOT_RELATIVE_PATHS,
    *GRAPHIFY_OWNED_VERSION_MARKER_RELATIVE_PATHS,
)
...
def _graphify_managed_profile_paths(home: Path | None = None) -> tuple[Path, ...]:
    ...
    return tuple(profile_home / relative_path for relative_path in GRAPHIFY_PROFILE_RELATIVE_PATHS)
...
def install_graphify_runtime(body: str) -> str:
    ...
    status_lines = [
        ...
        f"managed_version_marker_count={len(GRAPHIFY_OWNED_VERSION_MARKER_RELATIVE_PATHS)}",
    ]
