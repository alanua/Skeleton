...
def home_edge_01_read_only_diagnostic() -> str:
    ...
    status_lines = [
        ...
        f"connected_device_count={compact['connected_device_count']}",
        f"gateway_presence={compact['gateway_presence']}",
        f"connectivity_hardware={compact['connectivity_hardware']}",
