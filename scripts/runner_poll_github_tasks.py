...
def home_edge_01_display_power_off_controller_v1(body: str) -> str:
    task_id = HOME_EDGE_01_DISPLAY_POWER_OFF_CONTROLLER_V1
    try:
...
def dispatch_runtime_maintenance_task(
    ...
    try:
        ...
        if task_id == HOME_EDGE_01_DISPLAY_POWER_OFF_CONTROLLER_V1:
            return home_edge_01_display_power_off_controller_v1(body)
