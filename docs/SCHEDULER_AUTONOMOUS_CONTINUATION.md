...
privacy, bounded payload shape, and approved capabilities before calling an
existing typed route. The initial production route is the existing loop runner
packet path: `loop/loop_engine_packet`.
