...
EXPECTED_MAIN = '8e43719872024e0518a9faf5a93a9a916d03fab2'
...
INSTALLER_BLOB = 'ae105e2a6f23f3681bc1a4cf4a7485389a81f6cd'
INSTALLER_SHA256 = 'abe57cc80e562daded4580424eddc3319ff164742718d21f04d08dd150a0b37d'
WRAPPER_BLOB = 'd248088477a7c59219a9c19c47bcfc464c6dcd27'
PAYLOAD_BLOB = '6800e8b61a0d951ab09e63162bb03a6a56cb4b83'
STAGE1_INSTALLER_BLOB = 'e2c2378660df0cbaaf02e4556a1d1887a258b863'
...
def verify_blob_file(path: Path, blob: str, mode: int) -> None:
    if require_regular(path, mode) != blob_bytes(blob):
...
def main() -> int:
    ...
    if remote_line != f'{EXPECTED_MAIN}\trefs/heads/main' or head != EXPECTED_MAIN or origin_main != EXPECTED_MAIN:
    ...
    try:
        ...
        if require_regular(PROTECTED_INSTALLER, 0o555) != installer:
