...
# The compatibility wrapper is intentionally Codex-only. External-model execution
# is authorized by ExecutionBinding/RouteLease, never as an implicit child fallback.
...
def _install_fallback_wrapper(
    ...
    The historical function name remains for call-site compatibility. It no
    longer authorizes OpenHands or any model-provider fallback.
    """
