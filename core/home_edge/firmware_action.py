...
class FirmwareTransferRequest:
    ...
    postflight_effects: tuple[str, str] = ("CY Anemone", "CY Tidal Bloom")
    idempotency_key: str = "lavalamp-c98acbf-build-ota-1922"
...
class HomeEdgeFirmwareAction:
    ...
    def _validate_request(self, request: FirmwareTransferRequest) -> None:
        ...
        if request.postflight_effects != ("CY Anemone", "CY Tidal Bloom"):
...
def _public_remote_receipt(
    ...
    *,
    ...
    effect_bools = {
        effect: effects.get(effect) is True for effect in request.postflight_effects
    }
