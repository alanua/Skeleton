...
def test_runner_enabled_codex_issue_worktree_projects_are_explicitly_allowed() -> None:
    tree = loaded_tree()
...
def test_aufmass_private_codex_worktree_route_stays_private_and_gated() -> None:
    ...
    assert aufmass_private["repo"] == "private/aufmass"


def test_home_automation_private_project_remains_disabled_and_planning_only() -> None:
    tree = loaded_tree()
    project = tree["projects"]["home_automation"]

    assert project["public"] is False
    assert project["runner_enabled"] is False
    assert project["execution_modes"]["planning_only"] is True
    assert project["execution_modes"]["codex_issue_worktree"] is False
